...
class Phrex:
    def __init__(self) -> None:
        ...
        self.CHUNKS = [folders[i:i + CHUNK_SIZE] for i in range(0, len(folders), CHUNK_SIZE)]
    ...
    def _proccess_data(self, dataset):
        features = []
        labels = []
        ...
        for index in range(len(dataset)):
            ...
            for i in range(64):
                ...
                if i % 2 == 0:
                    ...
                    feature = choice(dataset[self._getRandom(index, len(dataset))])
    ...
    def train(self, chunk_index=0):
        for chunk in self.CHUNKS[chunk_index:]:
            ...
            self.model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=2, batch_size=16)
